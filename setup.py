...
setup(
    ...
    description='helps with web documentation of Linux systems that use modules to access software.',
    long_description='https://github.com/JoannaLeng/module_tables/blob/master/README.md#module-table-readme',
    platforms="Linux",
